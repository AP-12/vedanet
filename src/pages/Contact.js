...
const Contact = () => {
  ...
  const submitForm = async (formData) => {
    ...
    const PHP_BACKEND_ENDPOINT = 'http://localhost/backend/contact-form.php'; // Update this URL when deploying
  ...
  const reverseGeocode = async (latitude, longitude) => {
    try {
      const response = await fetch(
        ...
        {
          headers: {
            'User-Agent': 'ItWeb Contact Page/1.0'
          }
        }
      );
            ...
            <div>
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <a href="#" className="flex items-center justify-center w-12 h-12 bg-blue-100 rounded-lg hover:bg-blue-200 transition-colors">
